...
async def generate(**kwargs):
    ...
    generator = DataGeneratorFactory.data_generator(kwargs['generator_type'], model_schema=kwargs['model'].schema(),
                                                    avro_schema=kwargs['avro_schema'])

    #create serialzation context


    await generator.generate_data(num_records=kwargs['num_of_records'], model=kwargs['mode'], writer_context=context, kwargs=kwargs)
