...
class FileWriterFactory(KafkaWriterFactory):
    @staticmethod
    def get_writer(serialization_format: str, **kwargs) -> FileWriter:
        if serialization_format != 'json':
            loguru.logger.warning('Unsupported serialization format for file writer: {serialization_format}. Defaulting to JSON.')
