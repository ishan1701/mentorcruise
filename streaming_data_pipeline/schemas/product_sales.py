...
product_sales_schema_iceberg = Schema(
    pyiceberg_types.NestedField(1, "product_id", pyiceberg_types.StringType(), required=True),
    pyiceberg_types.NestedField(2, "quantity", pyiceberg_types.IntegerType(), required=True),
    pyiceberg_types.NestedField(3, "price", pyiceberg_types.FloatType(), required=True),
    pyiceberg_types.NestedField(4, "timestamp", pyiceberg_types.StringType(), required=True)
)
